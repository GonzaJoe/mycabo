...
class PhoneVerification extends StatefulWidget {
  //final userName;
  PhoneAuthCredential mobileAuthCredential;
  PhoneVerification({this.mobileAuthCredential});
...
class _PhoneVerificationState extends State<PhoneVerification> with SingleTickerProviderStateMixin {
                              ...
                              return Stack(
                                ...
                                children: <Widget>[
                                  ...
                                  Transform(
                                    transform: new Matrix4.translationValues(
                                      0.0,
                                      160*(1.0-(AlwaysStoppedAnimation(Tween(begin: 0.8, end: 1.0).animate(CurvedAnimation(parent: animationController, curve: Curves.fastOutSlowIn))).value).value),
                                      0.0
                                    ),
                                    child: Image.asset(
            ...
            SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: Column(
                  children: <Widget>[
                    SizedBox(
                      height: (MediaQuery.of(context).size.height / 2) - (MediaQuery.of(context).size.width < 360 ? 124 : 60),
                    ),
                    Padding(
  ...
  void verifyOTP()async{
    ...
    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>RiderInfo()),(route) => false,);
  }
}
